...
describe('list', () => {
  ...
  it('allergic to everything', () => {
    ...
    const expected = ['eggs', 'peanuts', 'shellfish', 'strawberries', 'tomatoes', 'chocolate', 'pollen', 'cats'];
    expect(allergies.list()).toEqual(expected);
  });
  ...
  it('ignore unknown allergen score parts', () => {
    ...
    const expected = ['eggs', 'shellfish', 'strawberries', 'tomatoes', 'chocolate', 'pollen', 'cats'];
    expect(allergies.list()).toEqual(expected);
  });
});
